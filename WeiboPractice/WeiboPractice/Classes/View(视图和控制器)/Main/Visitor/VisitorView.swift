...
class VisitorView: UIView {
    ...
    ///注册按钮
    private lazy var registerButton: UIButton = UIButton(title: "注册", fontSize: 13, color: UIColor.orange, imageName: "common_button_white_disable")
//        {let button = UIButton()
...
//        return button
    //}()
    ///注册按钮
    private lazy var loginButton: UIButton = UIButton(title: "登录", fontSize: 13, color: UIColor.darkGray, imageName: "common_button_white_disable")
...
extension VisitorView {
    ...
    private func setupUI() {
        ...
        //3.添加监听方法
        registerButton.addTarget(self, action: #selector(clickRegister), for: UIControl.Event.touchUpInside)
